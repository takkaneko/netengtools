...
from flexresources import choose_switchport,choose_flexport_IAD,print_results_IAD
from flexresources import ask_symmetric_or_not,choose_switchports_HA,choose_flexports_IAD_HA
from flexresources import print_results_IAD_HA,ask_more
...
def main():
    ...
    while more == 'y':
        ...
        if dual == 'n':
            ...
            [flexport,idf_port,idf_num] = choose_flexport_IAD(use_this_switch,SW1,loc)
            
            # Outputs, non-HA
            print_results_IAD(sid,loc,spd,type,typeDict,flexport,idf_num,u_num,idf_port,
        ...
        # Case II: Dual cabling type (hbeat, vmotion, pri+, sec+, or otherha).
            ...
            [prim_flexport,sec_flexport,
             ...
             prim_sw,sec_sw,
             prim_port,sec_port] = choose_flexports_IAD_HA(trace,loc,pri_or_sec,
                                                           priSW,pr2SW,secSW,
                                                           se2SW,port1,port2)
            
            print_results_IAD_HA(sid,loc,typeDict,type,spd,
